...
const translations = {
  ...
  en: {
    ...
    "last-name-ja": "Last Name (JP)",
    "first-name-ja": "First Name (JP)",
    ...
    "select-leader-placeholder": "Select leader...",
    "select-sub-leader-placeholder": "Select sub-leader...",
    ...
    "special-leave": "Special Leave",
    "compensatory-leave": "Compensatory Leave",
    "compensatory-leave-planned": "Planned Compensatory",
    "absence": "Absence",
    "late": "Late",
    "early-leave": "Early Leave",
    "delay": "Delay",
